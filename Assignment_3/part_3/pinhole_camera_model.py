...
if __name__ == '__main__':
    ...
    # load model
    bfm = h5py.File("Data/model2017-1_face12_nomouth.h5", 'r')  ########################## could not load model so made a folder Data/ containing the model in part 3 directory
    ...
    model = model = MyPCAModel(bfm, 30, 20)
    ...
    with open("Landmarks68_model2017-1_face12_nomouth.anl", mode="r", encoding="utf-8") as f:
    ...
    plt.savefig("2D_image_plane.png")
    plt.show()
