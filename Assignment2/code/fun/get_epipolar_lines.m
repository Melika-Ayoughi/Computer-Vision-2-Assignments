function [] = get_epipolar_lines(Fs, img1, img2, p_1, p_2, n)  % DOCSTRING_GENERATED
...
for i = 1:size(p1, 1)
    ...
    title(string(method)+" normalized="+string(norm));
end
